...
example runs:
  ...
  python scripts/train_sft.py --no-hub

  # optional overrides
  python scripts/train_sft.py --run-name qwen2.5-1.5b_sft_debug --wandb-project tulu-postraining
  python scripts/train_sft.py --hub-username <you>
"""
