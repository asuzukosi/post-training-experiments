...
example runs:
  ...
  python scripts/train/ppo.py \\
    --sft-checkpoint results/checkpoints/<sft_run> \\
    --rm-checkpoint results/checkpoints/<rm_run>

  # skip hub push (local/debug)
  python scripts/train/ppo.py --sft-checkpoint <sft> --rm-checkpoint <rm> --no-hub

  # optional overrides
  python scripts/train/ppo.py --sft-checkpoint <sft> --rm-checkpoint <rm> --run-name qwen2.5-1.5b_ppo_debug
"""
