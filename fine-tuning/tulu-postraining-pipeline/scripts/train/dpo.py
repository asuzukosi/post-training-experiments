...
example runs:
  ...
  python scripts/train/dpo.py --sft-checkpoint results/checkpoints/<sft_run> --beta 0.05
  python scripts/train/dpo.py --sft-checkpoint <sft> --beta 0.1

  # skip hub push (local/debug)
  python scripts/train/dpo.py --sft-checkpoint <sft> --beta 0.05 --no-hub

  # optional overrides
  python scripts/train/dpo.py --sft-checkpoint <sft> --beta 0.05 --run-name qwen2.5-1.5b_dpo-b0.05_debug
"""
