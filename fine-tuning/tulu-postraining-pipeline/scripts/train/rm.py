...
example runs:
  ...
  python scripts/train/rm.py --sft-checkpoint results/checkpoints/<sft_run>
  python scripts/train/rm.py --config configs/rm.yaml --sft-checkpoint <sft_run_or_path>

  # skip hub push (local/debug)
  python scripts/train/rm.py --sft-checkpoint <sft> --no-hub

  # optional overrides
  python scripts/train/rm.py --sft-checkpoint <sft> --run-name qwen2.5-1.5b_rm_debug
  python scripts/train/rm.py --sft-checkpoint <sft> --hub-username <you>
"""
