"""head-to-head orchestration: generate a/b → judge → optional style report.
...
from pipeline.eval.generate import generate_incremental
from pipeline.eval.io import load_jsonl
from pipeline.eval.judge import DEFAULT_JUDGE_MODEL, judge_incremental, judgment_id
...
def run_head_to_head(
    *,
    ...
    judge_generate_fn: Any | None = None,
) -> dict[str, Any]:
    ...
    for run in range(1, runs + 1):
        ...
        payload["length_control_requested"] = length_control
