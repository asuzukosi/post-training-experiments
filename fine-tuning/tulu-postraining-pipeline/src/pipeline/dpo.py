...
from pipeline.data_tools.naming import checkpoint_dir, make_run_name
from pipeline.hub import hub_trainer_kwargs, push_checkpoint_to_hub
...
def load_dpo_dataset(processed_path: str | Path):
    ...
    if not path.exists():
        raise FileNotFoundError(
            ...
            "run: python scripts/prepare_data.py --dpo"
        )
